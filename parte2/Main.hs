...
-- Esegue l'intera pipeline su un singolo file: parsing, analisi di semantica statica, pretty-print del sorgente e, solo se non ci sono
-- errori di tipo, generazione e pretty-print del three-address code. Un errore di parsing e un errore di tipo restano ben distinti fra
