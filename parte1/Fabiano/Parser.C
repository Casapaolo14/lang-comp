...
#define yyparse         grammatica_parse
#define yylex           grammatica_lex
#define yyerror         grammatica_error
#define yydebug         grammatica_debug
#define yynerrs         grammatica_nerrs

/* First part of user prologue.  */
#line 20 "Grammatica.y"
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL__KW_name = 12,                  /* _KW_name  */
  YYSYMBOL__KW_section = 13,               /* _KW_section  */
  YYSYMBOL__KW_true = 14,                  /* _KW_true  */
  ...
  YYSYMBOL_ListSection = 25,               /* ListSection  */
  YYSYMBOL_ListField = 26                  /* ListField  */
};
typedef enum yysymbol_kind_t yysymbol_kind_t;


/* Second part of user prologue.  */
#line 68 "Grammatica.y"
...
static const char *const yytname[] =
{
  ...
  "_DOT", "_LT", "_SYMB_3", "_EQ", "_GT", "_KW_false", "_KW_field",
  "_KW_name", "_KW_section", "_KW_true", "_STRING_", "_INTEGER_",
  "_IDENT_", "$accept", "Config", "Section", "Field", "Value", "Ref",
  "Boolean", "ListSection", "ListField", YY_NULLPTR
};
...
{
     -10,     3,    -2,   -10,    -8,   -10,    -3,    -1,    -9,     4,
     -10,    -5,     5,     1,   -10,     6,     8,     7,   -10,     2,
      11,    -4,     9,   -10,   -10,   -10,   -10,    14,   -10,   -10,
      17,    12,    10,    15,   -10,   -10
};
...
{
      13,     0,     2,     1,     0,    14,     0,     0,     0,     0,
      15,     0,     0,     0,    16,     0,     0,     0,     3,     0,
       0,     0,     0,    12,    11,     7,     5,     0,     8,     6,
       9,     0,     0,     0,    10,     4
};
...
{
      22,    12,    13,     3,     4,     6,    23,     8,     9,     7,
      24,    25,    26,    10,    16,    19,    15,    18,    17,    20,
      21,    31,    32,    33,    35,     0,    30,    34
};

static const yytype_int8 yycheck[] =
{
       4,     6,     7,     0,     6,    13,    10,     8,    17,    12,
      14,    15,    16,     9,    13,     8,    11,     9,    12,    17,
       9,     7,     5,    11,     9,    -1,    17,    17
};
...
{
       0,    19,    25,     0,     6,    20,    13,    12,     8,    17,
       9,    26,     6,     7,    21,    11,    13,    12,     9,     8,
      17,     9,     4,    10,    14,    15,    16,    22,    23,    24,
      17,     7,     5,    11,    17,     9
};
...
#line 120 "Grammatica.y"
                                                                                     { Sect* tmp = new Sect((yyvsp[-5]._string), (yyvsp[-3].listfield_)); (yyval.section_) = tmp; result->section_ = (yyval.section_); registraRigaSezione(tmp, (yyloc).first_line); registraChiusuraSezione(tmp, (yyloc).last_line); }
#line 1285 "Parser.C"
    break;

  case 4: /* Field: _LT _KW_field _KW_name _EQ _IDENT_ _GT Value _SYMB_3 _KW_field _GT  */
#line 122 "Grammatica.y"
